...
x <- subset(g4, Nids == 500) %>%
  subset(Nsnps> 190000) %>%
  subset(!duplicated(Full.Iteration.ID))

ggplot(x,aes(x = BP, y = -log(Pexact)))+
  facet_wrap(~Chromosome)+
  geom_point()


x <- read.csv("Data/Scenario_4/Scenario_4_reruns_Ne500.csv")
head(x)
```
